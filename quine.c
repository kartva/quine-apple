...
const char *df(const char *da) {
	...
	while(*da != 126) { 
		// Get the packed value and unpack it
		char packed = *da++ - 35; 
		int count = (packed >> 1) & 31;
		char value = (packed & 1) ? 35 : 32;
